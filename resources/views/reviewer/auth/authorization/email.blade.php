    ...
    <div class="page-wrapper default-version">
        <div class="form-area bg_img" data-background="{{asset('assets/admin/images/1.jpg')}}">
            <div class="form-wrapper">
                ...
                <form action="{{route('reviewer.verify_email')}}" method="POST" class="login-form">
                    @csrf

                    <div class="form-group">
                        <p class="text-center">@lang('Your Email:')  <strong>{{auth()->guard('reviewer')->user()->email}}</strong></p>
                    </div>
                    ...
                    <div class="btn-area text-center">
                        ...
                        <div class="form-group">
                            <p class="text-center">@lang('Please check including your Junk/Spam Folder. if not found, you can ') <a href="{{route('reviewer.send_verify_code')}}?type=email" class="forget-pass"> @lang('Resend code')</a></p>
