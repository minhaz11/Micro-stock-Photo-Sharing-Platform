           ...
           <div class="col-md-4">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center font-weight-bold">@lang('Attribution')
                            <span class="font-weight-light text-primary">{{$image->attribution}}</span>
                        </li>
                ...
                <div class="d-flex justify-content-end">
                    <a href="javascript:void(0)"  data-route="{{route('reviewer.report.remove',$image->id)}}" class="btn btn--primary p-2 mr-3 w-75" data-msg="@lang('Are you sure want to remove all reports?')" onclick="action(this)"><i class="las la-trash"></i> @lang('Remove all reports')</a>

                    <a class="btn btn--danger p-2 w-75" href="javascript:void(0)" data-route="{{route('reviewer.report.banned',$image->id)}}" data-msg="@lang('Are you sure want to ban this photo?')" onclick="action(this)"><i class="las la-ban"></i> @lang('Ban this photo')</a>
                </div>
            ...
            <div class="col-lg-12">
                <div class="card b-radius--10 ">
                                   ...
                                   @if ($image->reports->count() > 0)
                                    ...
                                    <tr>
                                        <td data-label="@lang('Reported By')">
                                            <div class="user">
                                            <div class="thumb"><img src="{{getImage('assets/user/profile/'.@$report->user->image)}}" alt="image"></div>
                                        ...
                                        <a href="javascript:void(0)" data-route="{{route('reviewer.reported.remove',$report->id)}}" data-msg="@lang('Are you sure want to remove this report?')" class="icon-btn btn--danger"  data-original-title="@lang('remove')" onclick="action(this)">
                    ...
                    <div class="card-footer py-4">
                     {{$image->reports->paginate(15)->links('reviewer.partials.paginate')}}
                    </div>
                </div><!-- card end -->
            </div>
        </div>
...
<a href="{{route('reviewer.reported.pending')}}" class="btn btn--primary"><i class="las la-backward"></i> @lang('Go Back')</a>
