  ...
  <div class="pt-60 pb-60">
    <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-10">
                    <div class="card">
                        <div class="card-header text-center font-weight-bold text-white base--bg">@lang('Please Verify Your Email to Get Access')</div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('user.verify_email')}}" method="POST" class="login-form">
                                ...
                                <div class="btn-area text-center">
                                    ...
                                    <div class="form-group">
                                        <p class="text-center">@lang('Please check including your Junk/Spam Folder. if not found, you can ') <a href="{{route('user.send_verify_code')}}?type=email" class="forget-pass"> @lang('Resend code')</a></p>
