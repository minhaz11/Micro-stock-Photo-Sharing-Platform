                ...
                <div class="card">
                    <div class="card-header  base--bg d-flex flex-wrap justify-content-between align-items-center">
                        <h5 class="card-title text-white mt-0">
                            ...
                            @endif
                           <span class="text-small ml-3"> [Ticket#{{ $my_ticket->ticket }}] {{ $my_ticket->subject }}</span>
                        </h5>

                        <button class="btn btn-dark close-button" type="button" title="@lang('Close Ticket')" data-toggle="modal" data-target="#DelModal"><i class="fa fa-lg fa-times-circle"></i>
                        </button>
                                            ...
                                            <form method="post"
                                                ...
                                                <div class="row justify-content-between">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>&nbsp;</label>
                                                            <button type="submit" class="btn cmn-btn custom-success" name="replayTicket" value="1">
