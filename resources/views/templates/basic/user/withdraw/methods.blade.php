            ...
            @foreach($withdrawMethod as $data)
                ...
                <div class="col-lg-4 col-md-4 mb-4">
                    <div class="card card-deposit ">
                        <h5 class="card-header text-center base--bg text-white">{{__($data->name)}}</h5>
                        ...
                        <div class="card-footer base--bg">
                            <a href="javascript:void(0)"  data-id="{{$data->id}}"
                               ...
                               class="btn btn-block  base--bg text-white deposit" data-toggle="modal" data-target="#exampleModal">
                                @lang('Withdraw Now')</a>
                        </div>
                    </div>
                </div>
