                ...
                @else
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mx-auto text-center">
                                <a href="#0" class="btn cmn-btn btn-lg mt-3 mb-1" data-toggle="modal" data-target="#enableModal">@lang('Enable Two Factor Authenticator')</a>
                            </div>
                        </div>
                    </div>
                @endif
            ...
            <div class="col-lg-6 col-md-6">
                <div class="card">
                    ...
                    <div class=" card-body">
                        ...
                        <a class="btn cmn-btn btn-md mt-3" href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2&hl=en" target="_blank">@lang('DOWNLOAD APP')</a>
                    </div>
