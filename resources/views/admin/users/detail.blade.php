            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body p-0">
                    <div class="p-3 bg--white">
                        <div class="">
                            <img src="{{ getImage('assets/user/profile/'. $user->image,'350x300')}}" alt="@lang('Profile Image')" class="b-radius--10 w-100">
                        </div>
                        <div class="mt-15">
            ...
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('User Type')
                            <span class="font-weight-bold">{{$user->con_flag == 1 ? 'Contributor':'User'}}</span>
                        </li>

                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Subscription Plan')
                            
                            <span class="font-weight-bold">{{$user->subscription ? $user->subscription->mainData->name:'N/A'}}</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row mb-none-30">
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--deep-purple b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{getAmount($totalDeposit,2)}}</span>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--indigo b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{getAmount($totalWithdraw,2)}}</span>
                                <span class="currency-sign">{{__($general->cur_sym)}}</span>
                            </div>
                            <div class="desciption">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--17 b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{getAmount($data['totalEarnings'])}} {{$general->cur_text}}</span>
                            </div>
                            <div class="desciption">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--17 b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{getAmount($user->balance)}} {{$general->cur_text}}</span>
                            </div>
                            <div class="desciption">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--1 b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{getAmount($data['totalFreePhoto'])}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Free Photo')</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--2 b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{getAmount($data['totalPremiumPhoto'])}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Premium Photo')</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--3 b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{getAmount($data['totalFreeDownload'])}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Free Photo Download')</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--4 b-radius--10 box-shadow has--link">
                        <a href="javascript:void(0)" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-download"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{getAmount($data['totalPremiumDownload'])}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Premium Photo Download')</span>
                            </div>
                        </div>
                    </div>
                </div>
