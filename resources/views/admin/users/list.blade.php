                        ...
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                <td data-label="@lang('User')">
                                    <div class="user">
                                        <div class="thumb">
                                            <img src="{{ getImage('assets/user/profile/'. $user->image,'350x300')}}" alt="@lang('image')">
                                        </div>
                                        <span class="name">{{$user->fullname}}</span>
                                    </div>
                                </td>
                                <td data-label="@lang('Username')"><a href="{{ route('admin.users.detail', $user->id) }}">{{ $user->username }}</a><small class="ml-2">{{$user->con_flag==1?'(contributor)':'(user)'}}</small></td>
