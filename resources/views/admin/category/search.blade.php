                        ...
                        <table class="table table--light style--two">
                                ...
                                <td>
                                    <div class="@lang('Image')">
                                        <div class="thumb"><img src="
                                            {{getImage('assets/admin/images/category/'.$category->image,'150x150')}}" alt="image">
                                        </div>
                            ...
                            <td data-label="@lang('Status')" class=""><span class="badge {{$category->status==1?'badge--success':'badge--warning'}}">{{$category->status==1? trans('active'):trans('deactive')}}</span></td>
                                ...
                                <td data-label="@lang('Action')">
                                    <a href="javascript:void(0)" class="icon-btn edit" data-toggle="tooltip" title="" data-original-title="Edit"
                                    data-name ="{{$category->name}}"
                                    data-image ="{{getImage('assets/admin/images/category/'.$category->image,'250x250P')}}"
            ...
            <div class="image-upload">
                <div class="thumb">
                    ...
                    <div class="avatar-edit">
                        ...
                        <small class="mt-2 text-facebook">@lang('Supported files:') <b>@lang('jpeg, jpg.')</b> @lang('Image will be resized into 250x250') </small>
                    </div>
                </div>
            </div>
        </div>
...
<a href="{{route('admin.category.all')}}"  class="btn btn--primary mr-5">
<i class="fas fa-backward"></i>   @lang(' Go back')
</a>
